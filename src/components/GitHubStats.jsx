      ...
      <AnimateOnScroll>
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center w-full">
            ...
            >
              <img
                ...
                alt="GitHub Stats"
                className="rounded-xl shadow-soft group-hover:shadow-accent-ring transition-shadow duration-300"
                loading="lazy"
              />
            </a>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group transition-transform duration-300 hover:scale-[1.02] w-full max-w-4xl"
          >
            <img
              ...
              className="w-full rounded-xl shadow-soft group-hover:shadow-accent-ring transition-shadow duration-300"
              loading="lazy"
            />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 px-8 py-4 bg-accent text-accent-foreground rounded-full font-bold shadow-lg hover:shadow-[0_8px_30px_rgba(255,152,0,0.4)] hover:scale-110 hover:-rotate-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-accent-ring flex items-center gap-2"
          >
